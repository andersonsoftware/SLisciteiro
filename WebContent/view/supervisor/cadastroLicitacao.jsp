...
<div class="container">
	...
	<div class="alert alert-success" role="alert">Licitação
	...
	<h3>
		<a type="button" class="btn btn-lg btn-default"
			href="cadastroProduto.jsp">Cadastrar Novo Produto</a>
	</h3>
	...
	<form class="" id="form_cadastro_liscitacao" method="post"
		...
		<div class="form-group">
			<div class="row">
				<div class="col-xs-6">
					<label>Produto: </label> <select name="produto" id="produto"
				...
				<div class="col-xs-6">
					<label for="quantidade_produto">Quantidade:</label> <input
						type="number" min=1 value=1 id="quantidade_produto"
						name="quantidade_produto" class="form-control ">
				</div>
			</div>
			<input type="button" value="Adicionar Produtos" id="add_produto"
		...
		<div class="form-group">
			<input type="submit" value="Cadastrar" onclick="addListReturn();"
